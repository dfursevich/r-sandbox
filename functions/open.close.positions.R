open.close.positions <- function(indicators, data, test.data, stop.loss = 0.1, take.profit = 1) {
...
open.close.positions.result <- open.close.positions(open.close.positions.indicators, open.close.positions.data, open.close.positions.test.data, 2, 10)
